import "./common/_commonjsHelpers-b1deedd1.js";
import { p as t } from "./common/index-1c71a884.js";
import e from "./react.js";
var n = function () {},
  o = function () {},
  r = function (t, e, n, o, r, i, a, c) {
    if (!t) {
      var s;
      if (void 0 === e)
        s = new Error(
...
var s = function (t) {
  ...
  l = function (t, e) {
    return p(t, e) ? t.substr(e.length) : t;
  },
  f = function (t) {
  ...
  d = function (t, e, n, o) {
    ...
    "string" == typeof t
      ...
      : (void 0 === (r = y({}, t)).pathname && (r.pathname = ""),
        r.search
          ...
          ? "/" !== r.pathname.charAt(0) &&
            (r.pathname = (function (t) {
              var e =
                ...
                s = r || c;
              if (
                (t && i(t) ? (o = n) : n.length && (o.pop(), (o = o.concat(n))),
                !o.length)
              )
                return "/";
              var u = void 0;
  ...
  v = function (t, e) {
    return (
      ...
      (function t(e, n) {
        ...
        var o = void 0 === e ? "undefined" : c(e);
        if (o !== (void 0 === n ? "undefined" : c(n))) return !1;
        if ("object" === o) {
          var r = e.valueOf(),
            i = n.valueOf();
  ...
  S = function () {
    ...
    var e = window.history,
      ...
      k = function (t) {
        ...
        return o(!S || p(a, S)), S && (a = l(a, S)), d(a, r, n);
      },
      A = function () {
      ...
      _ = m(),
      M = function (t) {
        R(X, t), (X.length = e.length), _.notifyListeners(X.location, X.action);
      },
      L = function (t) {
        E(t) || H(k(t.state));
      },
        ...
        _.confirmTransitionTo(i, "PUSH", y, function (t) {
          if (t) {
            var o = $(i),
              ...
              a = i.state;
            if (n)
              if ((e.pushState({ key: r, state: a }, null, o), c))
                window.location.href = o;
              else {
                var s = I.indexOf(X.location.key),
                  u = I.slice(0, -1 === s ? 0 : s + 1);
                u.push(i.key), (I = u), M({ action: "PUSH", location: i });
              }
        ...
        _.confirmTransitionTo(i, "REPLACE", y, function (t) {
          if (t) {
            var o = $(i),
              ...
              a = i.state;
            if (n)
              if ((e.replaceState({ key: r, state: a }, null, o), c))
      ...
      V = function (t) {
        1 === (J += t)
          ? (g(window, "popstate", L), i && g(window, "hashchange", q))
          : 0 === J &&
            (w(window, "popstate", L), i && w(window, "hashchange", q));
      },
      G = !1,
      z = function () {
        var t = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
  ...
  q = function () {
    ...
    var e = window.history,
      n = (P(), t.getUserConfirmation),
      i = void 0 === n ? O : n,
      a = t.hashType,
      c = void 0 === a ? "slash" : a,
      u = t.basename ? f(s(t.basename)) : "",
      y = A[c],
      x = y.encodePath,
      j = y.decodePath,
      E = function () {
        var t = j(_());
        return o(!u || p(t, u)), u && (t = l(t, u)), d(t);
      },
      T = m(),
      R = function (t) {
        k(Z, t), (Z.length = e.length), T.notifyListeners(Z.location, Z.action);
      },
      C = !1,
      S = null,
      q = function () {
    ...
    var I = E(),
      ...
      D = function (t, e) {
        var n = d(t, void 0, void 0, Z.location);
        T.confirmTransitionTo(n, "PUSH", i, function (t) {
          if (t) {
            var e = h(n),
              o = x(u + e);
            if (_() !== o) {
              (S = e), M(o);
              var r = $.lastIndexOf(h(Z.location)),
                i = $.slice(0, -1 === r ? 0 : r + 1);
              i.push(e), ($ = i), R({ action: "PUSH", location: n });
            } else R();
          }
        });
      },
      F = function (t, e) {
        var n = d(t, void 0, void 0, Z.location);
        T.confirmTransitionTo(n, "REPLACE", i, function (t) {
          if (t) {
            var e = h(n),
              o = x(u + e);
            _() !== o && ((S = e), L(o));
            var r = $.indexOf(h(Z.location));
            -1 !== r && ($[r] = e), R({ action: "REPLACE", location: n });
          }
        });
      },
      Y = function (t) {
      ...
      G = function (t) {
        1 === (V += t)
          ? g(window, "hashchange", q)
          : 0 === V && w(window, "hashchange", q);
      },
      z = !1,
      Q = function () {
        var t = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
  ...
  N = function () {
    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
      ...
      f = W(a, 0, r.length - 1),
      y = r.map(function (t) {
        return d(t, void 0, "string" == typeof t ? l() : t.key || l());
      }),
      v = h,
      b = function (t, n) {
        o(
      ...
      g = function (t, n) {
        ...
        u.confirmTransitionTo(r, "REPLACE", e, function (t) {
          t &&
            ((T.entries[T.index] = r), p({ action: "REPLACE", location: r }));
        });
      },
      w = function (t) {
        var n = W(T.index + t, 0, T.entries.length - 1),
          o = T.entries[n];
...
var D = (function (t) {
  function o() {
    ...
    for (var r = arguments.length, i = Array(r), a = 0; a < r; a++)
      i[a] = arguments[a];
    return (
      (e = n = B(this, t.call.apply(t, [this].concat(i)))),
  ...
  return (
    ...
    (o.prototype.componentWillReceiveProps = function (t) {
      n(this.props.history === t.history);
    }),
...
(D.propTypes = { history: t.object.isRequired, children: t.node }),
  (D.contextTypes = { router: t.object }),
  (D.childContextTypes = { router: t.object.isRequired });
var K = (function (t) {
  function o() {
    var e, n;
    F(this, o);
    for (var r = arguments.length, i = Array(r), a = 0; a < r; a++)
      i[a] = arguments[a];
    return (
      (e = n = Y(this, t.call.apply(t, [this].concat(i)))),
      (n.history = S(n.props)),
      Y(n, e)
    );
  }
...
var G = (function (t) {
  function o() {
    ...
    for (var r = arguments.length, i = Array(r), a = 0; a < r; a++)
      i[a] = arguments[a];
    return (
      (e = n = V(this, t.call.apply(t, [this].concat(i)))),
      (n.history = q(n.props)),
      V(n, e)
    );
  }
...
G.propTypes = {
  basename: t.string,
  getUserConfirmation: t.func,
  hashType: t.oneOf(["hashbang", "noslash", "slash"]),
  children: t.node,
};
var z =
  Object.assign ||
  ...
  tt = (function (t) {
    function n() {
      ...
      for (var r = arguments.length, i = Array(r), a = 0; a < r; a++)
        i[a] = arguments[a];
      return (
        (e = o = X(this, t.call.apply(t, [this].concat(i)))),
        (o.handleClick = function (t) {
          if (
            (o.props.onClick && o.props.onClick(t),
            !t.defaultPrevented && 0 === t.button && !o.props.target && !Z(t))
          ) {
            t.preventDefault();
    ...
    return (
      ...
      (n.prototype.render = function () {
        ...
        r(this.context.router, "You should not use <Link> outside a <Router>"),
          r(void 0 !== n, 'You must specify the "to" property');
        var a = this.context.router.history,
          c = "string" == typeof n ? d(n, null, null, a.location) : n,
          s = a.createHref(c);
        return e.createElement(
          "a",
          z({}, i, { onClick: this.handleClick, href: s, ref: o })
        );
      }),
      n
    );
...
var ot = (function (t) {
  function o() {
    ...
    for (var r = arguments.length, i = Array(r), a = 0; a < r; a++)
      i[a] = arguments[a];
    return (
      (e = n = nt(this, t.call.apply(t, [this].concat(i)))),
      (n.history = N(n.props)),
      nt(n, e)
    );
  }
...
function ht(t) {
  ...
  return function (n, o) {
    for (
      var r = "",
        i = n || {},
        a = (o || {}).pretty ? ft : encodeURIComponent,
        c = 0;
      c < t.length;
      c++
    ) {
    ...
    t instanceof RegExp
      ...
      ? (function (t, e, n) {
          for (var o = [], r = 0; r < t.length; r++)
            o.push(gt(t[r], e, n).source);
          return vt(new RegExp("(?:" + o.join("|") + ")", mt(n)), e);
        })(t, e, n)
      : (function (t, e, n) {
          return bt(lt(t, n), e, n);
        })(t, e, n)
  );
}
(it.parse = at),
  (it.compile = ct),
  (it.tokensToFunction = st),
  (it.tokensToRegExp = ut);
var wt = {},
  Ot = 0,
  xt = function (t, e) {
    ...
    if (o[t]) return o[t];
    var r = [],
      i = { re: it(t, r, e), keys: r };
    return Ot < 1e4 && ((o[t] = i), Ot++), i;
  },
  jt = function (t) {
    ...
    var o = e,
      ...
      p = void 0 !== u && u;
    if (null == r) return n;
    var l = xt(r, { end: a, strict: s, sensitive: p }),
      f = l.re,
      h = l.keys,
      y = f.exec(t);
    if (!y) return null;
    ...
    return (
      ...
      (o.prototype.computeMatch = function (t, e) {
        var n = t.computedMatch,
          ...
          s = t.sensitive;
        if (n) return n;
        r(e, "You should not use <Route> or withRouter() outside a <Router>");
        var u = e.route,
          p = (o || u.location).pathname;
        return jt(p, { path: i, strict: a, exact: c, sensitive: s }, u.match);
      }),
      (o.prototype.componentWillMount = function () {
        n(!(this.props.component && this.props.render)),
          n(
            !(
              this.props.component &&
              this.props.children &&
              !Rt(this.props.children)
            )
          ),
          n(
            !(
      ...
      (o.prototype.componentWillReceiveProps = function (t, e) {
        n(!(t.location && !this.props.location)),
          n(!(!t.location && this.props.location)),
...
(Ct.propTypes = {
  ...
  (Ct.childContextTypes = { router: t.object.isRequired });
var St =
    Object.assign ||
    function (t) {
      for (var e = 1; e < arguments.length; e++) {
...
var At = function (t) {
  var n = t.to,
    ...
    h = "object" === (void 0 === n ? "undefined" : kt(n)) ? n.pathname : n,
    y = h && h.replace(/([.+*?=^!:${}()[\]|/\\])/g, "\\$1");
...
(At.propTypes = {
  ...
  (At.defaultProps = { activeClassName: "active", "aria-current": "page" });
var Lt = (function (t) {
  function e() {
    return _t(this, e), Mt(this, t.apply(this, arguments));
  }
  return (
    (function (t, e) {
      if ("function" != typeof e && null !== e)
    ...
    (e.prototype.componentWillMount = function () {
      r(this.context.router, "You should not use <Prompt> outside a <Router>"),
...
(Lt.propTypes = {
  when: t.bool,
  message: t.oneOfType([t.func, t.string]).isRequired,
}),
  (Lt.defaultProps = { when: !0 }),
  (Lt.contextTypes = {
    router: t.shape({
      history: t.shape({ block: t.func.isRequired }).isRequired,
    }).isRequired,
  });
var qt = {},
  Ut = 0,
...
var Bt = (function (t) {
  function e() {
    return It(this, e), $t(this, t.apply(this, arguments));
  }
  return (
    (function (t, e) {
      if ("function" != typeof e && null !== e)
    ...
    (e.prototype.computeTo = function (t) {
      ...
      return e
        ? "string" == typeof n
          ? Wt(n, e.params)
          : Nt({}, n, { pathname: Wt(n.pathname, e.params) })
        : n;
    }),
...
(Bt.propTypes = {
  ...
  (Bt.defaultProps = { push: !1 }),
  (Bt.contextTypes = {
    router: t.shape({
      history: t.shape({ push: t.func.isRequired, replace: t.func.isRequired })
        .isRequired,
      staticContext: t.object,
    }).isRequired,
  });
...
var Kt = function (t) {
  ...
  Jt = function (t, e) {
    return t ? Dt({}, e, { pathname: Kt(t) + e.pathname }) : e;
  },
  Vt = function (t, e) {
    if (!t) return e;
    var n = Kt(t);
    return 0 !== e.pathname.indexOf(n)
      ? e
      : Dt({}, e, { pathname: e.pathname.substr(n.length) });
  },
  Gt = function (t) {
  ...
  zt = function (t) {
    return function () {
      r(!1, "You cannot %s with <StaticRouter>", t);
    };
  },
  Qt = function () {},
  Xt = (function (t) {
    function o() {
      ...
      return (
        ...
        (n.createHref = function (t) {
          return Kt(n.props.basename + Gt(t));
        }),
      ...
      (o.prototype.render = function () {
        var t = this.props,
          ...
          i = {
            ...
            go: zt("go"),
            goBack: zt("goBack"),
            goForward: zt("goForward"),
            listen: this.handleListen,
            block: this.handleBlock,
          };
        return e.createElement(D, Dt({}, r, { history: i }));
      }),
      o
    );
  })(e.Component);
...
(Xt.propTypes = {
  ...
  (Xt.childContextTypes = { router: t.object.isRequired });
var ee = (function (t) {
  function o() {
    return Zt(this, o), te(this, t.apply(this, arguments));
  }
  return (
    (function (t, e) {
      if ("function" != typeof e && null !== e)
    ...
    (o.prototype.componentWillMount = function () {
      r(this.context.router, "You should not use <Switch> outside a <Router>");
    }),
    (o.prototype.componentWillReceiveProps = function (t) {
      n(!(t.location && !this.props.location)),
        n(!(!t.location && this.props.location));
...
(ee.contextTypes = {
  ...
  (ee.propTypes = { children: t.node, location: t.object });
var ne = {
    childContextTypes: !0,
    contextTypes: !0,
    defaultProps: !0,
...
var fe = function (n) {
  var o = function (t) {
    ...
    return e.createElement(Ct, {
      children: function (t) {
        return e.createElement(n, le({}, r, t, { ref: o }));
      },
    });
  };
  return (
    (o.displayName = "withRouter(" + (n.displayName || n.name) + ")"),
    (o.WrappedComponent = n),
    (o.propTypes = { wrappedComponentRef: t.func }),
    pe(o, n)
  );
};
export {
