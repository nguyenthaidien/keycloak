            ...
            (function (global) {
              (function () {
                ...
                typedArrayTags[argsTag] = typedArrayTags[
                  ...
                  setTag
                ] = typedArrayTags[stringTag] = typedArrayTags[
                  weakMapTag
                ] = false;
                ...
                var ArrayBuffer =
                    isNative((ArrayBuffer = root.ArrayBuffer)) && ArrayBuffer,
                  bufferSlice =
                    isNative(
                      (bufferSlice = ArrayBuffer && new ArrayBuffer(0).slice)
                    ) && bufferSlice,
                  floor = Math.floor,
                  ...
                  Uint8Array =
                    isNative((Uint8Array = root.Uint8Array)) && Uint8Array;
                ...
                (function (x) {
                  ...
                  try {
                    support.nonEnumArgs = !propertyIsEnumerable.call(
                      arguments,
                      1
                    );
                  } catch (e) {
                ...
                function binaryIndexBy(array, value, iteratee, retHighest) {
                  ...
                  while (low < high) {
                    ...
                    if (valIsNaN) {
                      ...
                      setLow =
                        isReflexive && (retHighest || computed !== undefined);
                    } else {
                      setLow = retHighest
                        ? computed <= value
                        : computed < value;
                ...
                function createAssigner(assigner) {
                  return restParam(function (object, sources) {
                    ...
                    if (typeof customizer == "function") {
                      ...
                      customizer =
                        typeof thisArg == "function" ? thisArg : null;
                ...
                function isKey(value, object) {
                  ...
                  return (
                    result || (object != null && value in toObject(object))
                  );
                }
                ...
                function isStrictComparable(value) {
                  return (
                    value === value &&
                    (value === 0 ? 1 / value > 0 : !isObject(value))
                  );
                }
                ...
                function unzip(array) {
                  var index = -1,
                    length =
                      (array &&
                        array.length &&
                        arrayMax(arrayMap(array, getLength))) >>> 0,
                    result = Array(length);
                ...
                var isFunction = !(
                  baseIsFunction(/x/) ||
                  (Uint8Array && !baseIsFunction(Uint8Array))
                )
                  ? baseIsFunction
                  : function (value) {
                ...
                function has(object, path) {
                  ...
                  if (!result && !isKey(path)) {
                    ...
                    path = last(path);
                    result =
                      object != null && hasOwnProperty.call(object, path);
                  }
                  return result;
                }
            ...
            var JSHINT = (function () {
                    ...
                    : function () {
                        ...
                        if (this.id === "++" || this.id === "--") {
                          ...
                          if (this.right && this.right.isMetaProperty) {
                            ...
                            state.funct["(scope)"].block.modify(
                              this.right.value,
                              this
                            );
                          }
              ...
              function checkLeftSideAssign(left, assignToken, options) {
                ...
                if (left.id === ".") {
                  ...
                  if (
                    allowDestructuring &&
                    state.tokens.curr.left.destructAssign
                  ) {
                  ...
                  if (
                    state.funct["(scope)"].labeltype(left.value) === "exception"
                  ) {
                    warning("W022", left);
                  }
              ...
              function block(ordinary, stmt, isfunc, isfatarrow, iscase) {
                ...
                if (state.tokens.next.id === "{") {
                  ...
                  state.funct["(noblockscopedvar)"] =
                    state.tokens.next.id !== "for";
                  state.funct["(scope)"].stack();
              ...
              prefix("(", function () {
                ...
                if (exprs.length > 1) {
                  ...
                  if (!isNecessary) {
                    isNecessary =
                      (opening.beginsStmt &&
                        (ret.id === "{" || triggerFnExpr || isFunctor(ret))) ||
                      (triggerFnExpr &&
                ...
                if (ret) {
                  if (
                    !isNecessary &&
                    (first.left || first.right || ret.exprs)
                  ) {
                    isNecessary =
                      (!isBeginOfExpr(preceeding) &&
                        first.lbp <= preceeding.lbp) ||
              ...
              function isMethod() {
                return (
                  (state.funct["(statement)"] &&
                    state.funct["(statement)"].type === "class") ||
                  (state.funct["(context)"] &&
                    state.funct["(context)"]["(verb)"] === "class")
                );
              }
                ...
                for (var i = 0; state.tokens.next.id !== "}"; ++i) {
                  ...
                  if (name.id === "[") {
                    ...
                    if (name.identifier && name.value === "static") {
                      ...
                      if (
                        isPropertyName(state.tokens.next) ||
                        state.tokens.next.id === "["
                      ) {
              ...
              (function (x) {
                ...
                prefix("yield", function () {
                  ...
                  if (
                    this.line === startLine(state.tokens.next) ||
                    !state.inMoz()
                  ) {
                    if (
                      delegatingYield ||
              ...
              function saveAccessor(
                ...
                if (props[name]) {
                  if (
                    (props[name].basic || props[name][flagName]) &&
                    name !== "__proto__"
                  ) {
                    warning("W075", state.tokens.next, msg, name);
                  }
          ...
          function (_dereq_, module, exports) {
            ...
            Lexer.prototype = {
              ...
              isContext: function (context) {
                return (
                  this.context.length > 0 &&
                  this.context[this.context.length - 1] === context
                );
              },
                ...
                var create = function (type, value, isProperty, token) {
                  ...
                  if (type === "(identifier)") {
                    ...
                    if (_.has(state.syntax, value)) {
                      ...
                      if (
                        !isReserved(obj, isProperty && type === "(identifier)")
                      ) {
                        obj = null;
                      }
                    }
        ...
        "/node_modules/jshint/src/messages.js": [
          function (_dereq_, module, exports) {
            ...
            var warnings = {
              ...
              W044:
                "Bad or unnecessary escaping." /* TODO(caitp): remove W044 */,
              W045: "Bad number '{a}'.",
            ...
            var scopeManager = function (
              ...
              function _latedefWarning(type, labelName, token) {
                if (state.option.latedef) {
                  if (
                    (state.option.latedef === true && type === "function") ||
                    type !== "function"
                  ) {
              ...
              var scopeManagerInst = {
                ...
                isPredefined: function (labelName) {
                  return (
                    !this.has(labelName) &&
                    _.has(_scopeStack[0]["(predefined)"], labelName)
                  );
                },
                stack: function (type) {
                ...
                unstack: function () {
                  ...
                  if (
                    ...
                    usedLabelNameList.indexOf("__proto__") === -1
                  ) {
                  ...
                  for (i = 0; i < usedLabelNameList.length; i++) {
                    ...
                    if (subScope) {
                      ...
                      if (
                        typeof _current["(predefined)"][usedLabelName] ===
                        "boolean"
                      ) {
                  ...
                  if (
                    ...
                    for (i = 0; i < labelNames.length; i++) {
                      ...
                      if (
                        ...
                        subScope["(labels)"][defLabelName] =
                          currentLabels[defLabelName];
                ...
                addParam: function (labelName, token, type) {
                  ...
                  if (type === "exception") {
                    var previouslyDefinedLabelType = this.funct.labeltype(
                      labelName
                    );
                    if (
                      previouslyDefinedLabelType &&
                      previouslyDefinedLabelType !== "exception"
                    ) {
                      if (!state.option.node) {
                ...
                addlabel: function (labelName, opts) {
                  ...
                  var isblockscoped =
                    type === "let" || type === "const" || type === "class";
                  var isexported =
                    (isblockscoped ? _current : _currentFunctBody)["(type)"] ===
                      "global" && _.has(exported, labelName);
                  _checkOuterShadow(labelName, token, type);
                  if (isblockscoped) {
                    ...
                    if (
                      ...
                      declaredInCurrentScope = !!_currentFunctBody["(parent)"][
                        "(labels)"
                      ][labelName];
                    }
                    if (
                    ...
                    var declaredInCurrentFunctionScope = scopeManagerInst.funct.has(
                      labelName
                    );
                    if (
                      !declaredInCurrentFunctionScope &&
                      usedSoFarInCurrentFunction(labelName)
                    ) {
                      _latedefWarning(type, labelName, token);
                    }
                    if (
                  ...
                  labeltype: function (labelName, options) {
                    ...
                    for (var i = currentScopeIndex; i >= 0; i--) {
                      ...
                      if (
                        ...
                        (!onlyBlockscoped ||
                          current["(labels)"][labelName]["(blockscoped)"])
                      ) {
          ...
          function (_dereq_, module, exports) {
            ...
            var state = {
              ...
              inES5: function (strict) {
                if (strict) {
                  return (
                    (!this.option.esversion || this.option.esversion === 5) &&
                    !this.option.moz
                  );
                }
                return (
