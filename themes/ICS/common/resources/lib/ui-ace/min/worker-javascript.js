                ...
                (function () {
                  ...
                  function hn(e, t) {
                    return function (n, i, s) {
                      return typeof i == "function" && s === r && Xn(n)
                        ? e(n, i)
                        : t(n, on(i, s, 3));
                    };
                  }
                  ...
                  function Cn(e) {
                    return (
                      typeof e == "number" && e > -1 && e % 1 == 0 && e <= Nt
                    );
                  }
                  function kn(e) {
                  ...
                  function ur(e) {
                    return (
                      (e = Q(e)), e && D.test(e) ? e.replace(_, "\\$&") : e
                    );
                  }
                  function ar(e, t, n) {
                  ...
                  var r,
                    ...
                    j = {};
                  (j[w] = j[E] = j[S] = j[x] = j[T] = j[N] = j[C] = j[k] = j[
                    L
                  ] = !0),
                    (j[o] = j[u] = j[b] = j[a] = j[f] = j[l] = j[c] = j[h] = j[
                      p
                    ] = j[d] = j[v] = j[m] = j[g] = j[y] = !1);
                  var F = {};
                  (F[o] = F[u] = F[b] = F[a] = F[f] = F[w] = F[E] = F[S] = F[
                    x
                  ] = F[T] = F[p] = F[d] = F[v] = F[g] = F[N] = F[C] = F[k] = F[
                    L
                  ] = !0),
                ...
                p = (function () {
                  ...
                  function O(e) {
                    ...
                    if (t && t.isFutureReservedWord && f.inES5()) {
                      if (!t.es5) return !1;
                      if (t.strictOnly && !f.option.strict && !f.isStrict())
                        return !1;
                  ...
                  function z() {
                    ...
                    if (e.type === "jshint" || e.type === "jslint")
                      t.forEach(function (t) {
                        ...
                        n === "module" &&
                          (zt(f.funct) || q("E055", f.tokens.next, "module"));
                  ...
                  function Q(e, t) {
                    ...
                    f.nameStack.push(),
                      !t &&
                        ...
                        W(0).value === "(" &&
                        (f.inMoz() ||
                          F("W118", f.tokens.next, "let expressions"),
                        (o = !0),
                        f.funct["(scope)"].stack(),
                        V("let"),
                        V("("),
                          ...
                          n &&
                            ...
                            (n.value !== "new" ||
                              (n.first &&
                                ...
                                n.first.value === ".")) &&
                            ((i = !1),
                            n.value !== f.tokens.curr.value && (s = !1)),
                          V(),
                          i &&
                            f.tokens.curr.id === "(" &&
                            f.tokens.next.id === ")" &&
                    ...
                    return (
                      o && f.funct["(scope)"].unstack(), f.nameStack.pop(), n
                    );
                  }
                  function G(e) {
                  ...
                  function Z(e) {
                    (e = e || f.tokens.curr),
                      e.line !== G(f.tokens.next) && F("E022", e, e.value);
                  }
                  function et(e, t) {
                    e.line !== G(t) &&
                      (f.option.laxcomma ||
                        (tt.first && (F("I001"), (tt.first = !1)),
                        F("W014", e, t.value)));
                  }
                  function tt(e) {
                    (e = e || {}),
                    ...
                    if (f.tokens.next.identifier && (!e.property || !f.inES5()))
                      switch (f.tokens.next.value) {
                        ...
                        case "with":
                          return (
                            q("E024", f.tokens.next, f.tokens.next.value), !1
                          );
                      }
                  ...
                  function wt(e, t, n) {
                    ...
                    return (
                      ...
                      e.id === "."
                        ? ((!e.left ||
                            (e.left.value === "arguments" && !f.isStrict())) &&
                            F("E031", t),
                        ...
                        ? (q("E031", t), !0)
                        : e.identifier && !O(e)
                        ? (f.funct["(scope)"].labeltype(e.value) ===
                            "exception" && F("W022", e),
                          f.nameStack.set(e),
                          !0)
                        : (e === f.syntax["function"] &&
                      ...
                      (t.led = function (e) {
                        return (
                          ...
                          e.isMetaProperty
                            ...
                            : e &&
                              e.identifier &&
                              f.funct["(scope)"].block.modify(e.value, e),
                          (this.left = e),
                          this
                        );
                      }),
                  ...
                  function Ct(e, t) {
                    ...
                    if (f.tokens.next.value === "...") {
                      f.inES6(!0) ||
                        F("W119", f.tokens.next, "spread/rest operator", "6"),
                        V();
                      if (pn(f.tokens.next, "...")) {
                  ...
                  function Lt() {
                    if (f.tokens.next.id !== ";") {
                      ...
                      var e =
                          G(f.tokens.next) === f.tokens.curr.line &&
                          f.tokens.next.id !== "(end)",
                        t = pn(f.tokens.next, "}");
                      e && !t
                  ...
                  function At() {
                    ...
                    i &&
                      ...
                      n.identifier &&
                        ...
                        (r = !0),
                        f.funct["(scope)"].stack(),
                        f.funct["(scope)"].block.addBreakLabel(n.value, {
                          token: f.tokens.curr,
                        }),
                  ...
                  function Mt() {
                    ...
                    while (f.tokens.next.id === "(string)") {
                      ...
                      (f.directive[r] ||
                        (r === "use strict" &&
                          f.option.strict === "implied")) &&
                        F("W034", f.tokens.curr, r),
                        (f.directive[r] = !0),
                        t.id === ";" && V(";");
                    }
                    f.isStrict() &&
                      (f.option["(explicitNewcap)"] || (f.option.newcap = !0),
                      (f.option.undef = !0));
                  }
                      ...
                      if (f.tokens.next.id !== "}") {
                        ...
                        if (n) {
                          ...
                          for (p in f.directive)
                            r.has(f.directive, p) && (l[p] = f.directive[p]);
                          Mt(),
                            f.option.strict &&
                  ...
                  function Bt() {
                    ...
                    return (
                      f.tokens.next.value !== "for" &&
                        ((t = !0),
                        f.inMoz() ||
                          F("W116", f.tokens.next, "for", f.tokens.next.value),
                        f.funct["(comparray)"].setState("use"),
                        (e.right = Q(10))),
                      V("for"),
                      f.tokens.next.value === "each" &&
                        (V("each"),
                        f.inMoz() || F("W118", f.tokens.curr, "for each")),
                      V("("),
                  ...
                  function jt() {
                    return (
                      (f.funct["(statement)"] &&
                        f.funct["(statement)"].type === "class") ||
                      (f.funct["(context)"] &&
                        f.funct["(context)"]["(verb)"] === "class")
                    );
                  }
                  function Ft(e) {
                    return (
                      e.identifier || e.id === "(string)" || e.id === "(number)"
                    );
                  }
                  function It(e) {
                    var t,
                  ...
                  function qt(e) {
                    ...
                    for (;;) {
                      ...
                      if (r.contains(["{", "["], f.tokens.next.id)) {
                        ...
                        for (o in s)
                          (o = s[o]),
                            o.id && (n.push(o.id), p.push([o.id, o.token]));
                      } else {
                      ...
                      u &&
                        ...
                        f.tokens.next.id === "=" &&
                          (f.inES6() ||
                            F("W119", f.tokens.next, "default parameters", "6"),
                          V("="),
                          (u = !0),
                          Q(10)),
                        p.forEach(h);
                      if (f.tokens.next.id !== ",")
                        return V(")", t), { arity: l, params: n };
                  ...
                  function Wt(e) {
                    ...
                    if (!n)
                      while (!i())
                        !f.tokens.next.template || f.tokens.next.depth > r
                          ? Q(0)
                          : V();
                  ...
                  function Yt(e) {
                    var t,
                      ...
                      u = function () {
                        ...
                        if (hn(f.tokens.next, ["[", "{"])) {
                          t = Yt(s);
                          for (var r in t)
                            (r = t[r]), n.push({ id: r.id, token: r.token });
                          ...
                          if (!pn(f.tokens.next, "(")) {
                            ...
                            return (
                              e && n.push({ id: e, token: f.tokens.curr }), o
                            );
                          }
                          V("("), u(), V(")");
                        }
                    ...
                    if (pn(o, "[")) {
                      r || V("["),
                        pn(f.tokens.next, "]") && F("W137", f.tokens.curr);
                      var l = !1;
                  ...
                  function un(e) {
                    ...
                    for (var a = 0; f.tokens.next.id !== "}"; ++a) {
                      ...
                      if (t.id === "[") (t = cn()), (u = !0);
                        ...
                        if (!Ft(t)) {
                          F(
                            "W052",
                            f.tokens.next,
                            f.tokens.next.value || f.tokens.next.type
                          ),
                            V();
                          continue;
                        }
                      ...
                      if (i && t.value === "constructor") {
                        ...
                        t.value === "prototype" &&
                          q("E049", t, "class method", "prototype");
                      It(t),
                        Xt({
                          statement: e,
                  ...
                  ht(
                    ...
                    ut("...", function () {
                      return (
                        f.inES6(!0) ||
                          F("W119", this, "spread/rest operator", "6"),
                        !f.tokens.next.identifier &&
                    ...
                    ut("new", function () {
                      var e = Qt("target", function () {
                        f.inES6(!0) ||
                          F("W119", f.tokens.prev, "new.target", "6");
                        var e,
                          t = f.funct;
                        while (t) {
                          e = !t["(global)"];
                    ...
                    ut("(", function () {
                      ...
                      if (e.value === "=>")
                        return Xt({ type: "arrow", parsedOpening: !0 });
                      var h = [];
                      if (f.tokens.next.id !== ")")
                        for (;;) {
                          h.push(Q(10));
                    ...
                    (function (e) {
                      (e.nud = function () {
                        ...
                        return (
                          e && (g -= f.option.indent), V("}", this), Kt(u), this
                        );
                      }),
                        (e.fud = function () {
                          ...
                          !a &&
                            ...
                            (S[h.id] === !1
                              ...
                              : f.option.futurehostile === !1 &&
                                ((!f.inES5() &&
                                  s.ecmaIdentifiers[5][h.id] === !1) ||
                                  (!f.inES6() &&
                                    s.ecmaIdentifiers[6][h.id] === !1)) &&
                                F("W129", h.token, h.id)),
                          h.id &&
                            (a === "for"
                  ...
                  (rn.exps = !0),
                    ...
                    st("function", function (e) {
                      ...
                      return (
                        ...
                        r === undefined
                          ? F("W025")
                          : t &&
                            f.funct["(scope)"].setExported(r, f.tokens.prev),
                        Xt({
                          name: r,
                          statement: this,
                    ...
                    ut("function", function () {
                      ...
                      var t = Nt();
                      return (
                        Xt({ name: t, type: e ? "generator" : null }), this
                      );
                    }),
                    st("if", function () {
                      var e = f.tokens.next;
                    ...
                    st("try", function () {
                      function t() {
                        ...
                        f.tokens.next.value === "if" &&
                          (f.inMoz() ||
                            F("W118", f.tokens.curr, "catch filter"),
                          V("if"),
                          Q(0)),
                          V(")"),
                          _t(!1),
                      ...
                      while (f.tokens.next.id === "catch")
                        $t(),
                          e &&
                            !f.inMoz() &&
                            F("W118", f.tokens.next, "multiple catch blocks"),
                          t(),
                          (e = !0);
                    ...
                    (st("for", function () {
                      ...
                      if (r.contains(u, s.value)) {
                        ...
                        c && q("W133", l, s.value, "initializer is forbidden"),
                          l &&
                            q("W133", l, s.value, "more than one ForBinding"),
                      ...
                      return (
                        ...
                        f.tokens.curr.line === G(f.tokens.next)
                          ? (f.funct["(scope)"].funct.hasBreakLabel(e) ||
                            ...
                            V())
                          : f.funct["(breakage)"] === 0 &&
                            F("W052", f.tokens.next, this.value),
                        kt(this),
                        this
                      );
                    }).exps = !0),
                    ...
                    (it("export", function () {
                      var e = !0,
                        ...
                        n;
                      f.inES6() ||
                        (F("W119", f.tokens.curr, "export", "6"), (e = !1)),
                        f.funct["(scope)"].block.isGlobal() ||
                      ...
                      if (f.tokens.next.id === "var")
                        V("var"), f.tokens.curr.fud({ inexport: !0 });
                      else if (f.tokens.next.id === "let")
                        ...
                        var s = f.tokens.next;
                        f.syntax["class"].fud(),
                          f.funct["(scope)"].setExported(s.value, s);
                  ...
                  var an = function () {
                      ...
                      return {
                        ...
                        unstack: function () {
                          n.variables.filter(function (e) {
                            e.unused &&
                              F("W098", e.token, e.raw_text || e.value),
                              e.undef &&
                    ...
                    yn = function (t, i, o) {
                      ...
                      (e = {
                        ...
                        (f.tokens.prev = f.tokens.curr = f.tokens.next =
                          f.syntax["(begin)"]),
                        i &&
                          i.ignoreDelimiters &&
                  ...
                  return (
                    ...
                    (yn.data = function () {
                      var e = { functions: [], options: f.option },
                        ...
                        s,
                        o;
                      yn.errors.length && (e.errors = yn.errors),
                        f.jsonMode && (e.json = !0);
            ...
            function (e, t, n) {
              ...
              (p.prototype = {
                ...
                scanComments: function () {
                  ...
                  if (t === "/")
                    return this.skip(this.input.length), u("//", n);
                  var a = "";
                  if (t === "*") {
                ...
                next: function (e) {
                  ...
                  return n
                    ...
                    : ((n =
                      ...
                      n
                        ? (this.skip(n.tokenLength || n.value.length), n)
                        : null);
                },
                nextLine: function () {
                  var e;
                ...
                token: function () {
                  function n(e, t) {
                    ...
                    if (n && n.isFutureReservedWord && o.inES5()) {
                      if (!n.es5) return !1;
                      if (n.strictOnly && !o.option.strict && !o.isStrict())
                        return !1;
                      if (t) return !1;
                    }
                    return !0;
            ...
            function (e, t, n) {
              ...
              var r = e("../lodash"),
                i = {
                  ...
                  E054:
                    "Class properties must be methods. Expected '(' but instead saw '{a}'.",
                  E055:
                    "The '{a}' option cannot be set after any executable code.",
                  E056:
                    "'{a}' was used before it was declared, which is illegal for '{b}' variables.",
                ...
                s = {
                  ...
                  W104:
                    "'{a}' is available in ES{b} (use 'esversion: {b}') or Mozilla JS extensions (use moz).",
                  ...
                  W134:
                    "The '{a}' option is only available when linting ECMAScript {b} code.",
                ...
                o = function (e, t, n, o) {
                  function f(e) {
                    (u = {
                      ...
                      "(type)": e,
                      "(params)":
                        e === "functionparams" || e === "catchparams"
                          ? []
                          : null,
                    }),
                      a.push(u);
                        ...
                        for (p = 0; p < E.length; p++) {
                          ...
                          if (t)
                            if (!t["(usages)"][S])
                              ...
                              var k = t["(usages)"][S];
                              (k["(modified)"] = k["(modified)"].concat(
                                x["(modified)"]
                              )),
                                (k["(tokens)"] = k["(tokens)"].concat(
                                  x["(tokens)"]
                                )),
