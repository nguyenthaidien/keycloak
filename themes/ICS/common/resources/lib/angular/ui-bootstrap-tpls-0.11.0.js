          ...
          if (!isActive || angular.isDefined(attrs.uncheckable)) {
            scope.$apply(function () {
              ngModelCtrl.$setViewValue(
                isActive ? null : scope.$eval(attrs.btnRadio)
              );
              ngModelCtrl.$render();
            });
          }
        ...
        link: function (scope, element, attrs, ctrl) {
          ...
          ctrl._refreshView = function () {
            ...
            for (var i = 0; i < 42; i++) {
              days[i] = angular.extend(
                ctrl.createDateObject(days[i], ctrl.formatDay),
                {
          ...
          ctrl.handleKeyDown = function (key, evt) {
            ...
            if (key === "left") {
              ...
              var month =
                ctrl.activeDate.getMonth() + (key === "pageup" ? -1 : 1);
              ctrl.activeDate.setMonth(month, 1);
              date = Math.min(
                getDaysInMonth(
                  ctrl.activeDate.getFullYear(),
        ...
        link: function (scope, element, attrs, ctrl) {
          ...
          ctrl.handleKeyDown = function (key, evt) {
            ...
            if (key === "left") {
              ...
              var year =
                ctrl.activeDate.getFullYear() + (key === "pageup" ? -1 : 1);
        ...
        link: function (scope, element, attrs, ngModel) {
          ...
          function parseDate(viewValue) {
            if (!viewValue) {
              ...
              var date =
                dateParser.parse(viewValue, dateFormat) || new Date(viewValue);
              if (isNaN(date)) {
...
angular
  ...
  .controller("ProgressController", [
    ...
    function ($scope, $attrs, progressConfig) {
      ...
      this.bars = [];
      $scope.max = angular.isDefined($attrs.max)
