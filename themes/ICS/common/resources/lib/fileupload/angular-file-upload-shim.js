...
(function () {
      ...
      XMLHttpRequest = (function (origXHR) {
        return function () {
          ...
          xhr.getResponseHeader = (function (orig) {
            return function (h) {
              return xhr.__fileApiXHR
                ? xhr.__fileApiXHR.getResponseHeader(h)
                : orig.apply(xhr, [h]);
            };
          ...
          xhr.getAllResponseHeaders = (function (orig) {
            return function () {
              return xhr.__fileApiXHR
                ? xhr.__fileApiXHR.getAllResponseHeaders()
                : orig.apply(xhr);
            };
          ...
          xhr.send = function () {
            if (
              arguments[0] != null &&
              arguments[0].__isShim &&
              arguments[0].__setXHR_
            ) {
              var formData = arguments[0];
  ...
  if (!window.FormData) {
    ...
    var wrapFileApi = function (elem) {
      if (
        !elem.__isWrapped &&
        (elem.getAttribute("ng-file-select") != null ||
    ...
    var isFileChange = function (elem, e) {
      return (
        (e.toLowerCase() === "change" || e.toLowerCase() === "onchange") &&
